...
function App() {
  ...
  React.useEffect(() => {
    ...
    const filterhandler =  async () => {
      ...
      try {
        let data = await fetch(`http://localhost:8080/api/?added=${addYearfilter}&sector=${sectorfilter}&end_year=${endYearFilter}&topic=${topicFilter}&region=${regionFilter}&start_year=${startYearFilter}&published=${publishedYearFilter}&country=${countryFilter}&pestle=${pestleFilter}&source=${sourceFilter}`).then((res)=>res.json())
        // filter field data
        ...
        console.log(`http://localhost:8080/api/?added=${addYearfilter}&sector=${sectorfilter}&end_year=${endYearFilter}&topic=${topicFilter}&region=${regionFilter}&start_year=${startYearFilter}&published=${publishedYearFilter}&country=${countryFilter}&pestle=${pestleFilter}&source=${sourceFilter}`);
